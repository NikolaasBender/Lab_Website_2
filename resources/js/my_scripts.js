...
function hide() {
		...
		var h = document.getElementById("unhide");
...
function changeColor(color){
	document.getElementById("homePage").style.background = color;
}
...
document.getElementById("selectPlayerButton")		
...
function randomImage(){
		...
		if(pickImage == 0)
		{
			document.getElementById("practiceImg").src= "img/player1.jpg"; 
		}
		else if(pickImage == 1)
		{
			document.getElementById("practiceImg").src= "img/player2.jpg"; 
		}
		else
		{
			document.getElementById("practiceImg").src= "img/player3.jpg"; 
		}
